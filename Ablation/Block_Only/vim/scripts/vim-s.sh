...
torchrun --nproc_per_node=4 --master_port=15277 main.py --model Vim-Small --model-path ./pretrained_models/vim_s_midclstok_80p5acc.pth \
...
--token-keep-ratio 0.8 --block-keep-ratio 0.7 --token-pruning-weight 10.0 --block-pruning-weight 10.0 \
