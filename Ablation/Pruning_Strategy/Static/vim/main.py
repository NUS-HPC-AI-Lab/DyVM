...
def main(args):
    ...
    KEEP_RATE = [args.base_rate, args.base_rate ** 2, args.base_rate ** 3]
    PRUNING_LOC = None
    teacher_model = None
    if args.model == 'Vim-Tiny':
        PRUNING_LOC = [6, 12, 18]
        model = create_model(
            'VimTinyDiffPruning',
            pretrained=False,
        ...
        if not args.eval:
            ...
            teacher_model.to(device)
            teacher_model.eval()
    elif args.model == 'VideoMamba-Tiny':
        PRUNING_LOC = [6, 12, 18]
        model = create_model(
            'VideoMambaTinyDiffPruning',
            pretrained=False,
            num_classes=args.nb_classes,
            drop_rate=args.drop,
            drop_path_rate=args.drop_path,
        ...
        if not args.eval:
            ...
            teacher_model.to(device)
            teacher_model.eval()
    elif args.model == 'VideoMamba-Small':
        PRUNING_LOC = [6, 12, 18]
        model = create_model(
            'VideoMambaSmallDiffPruning',
            pretrained=False,
            num_classes=args.nb_classes,
            drop_rate=args.drop,
            drop_path_rate=args.drop_path,
        ...
        if not args.eval:
            ...
            teacher_model.to(device)
            teacher_model.eval()
    elif args.model == 'VideoMamba-Middle':
        PRUNING_LOC = [8, 16, 24]
        model = create_model(
            'VideoMambaMiddleDiffPruning',
            pretrained=False,
            num_classes=args.nb_classes,
            drop_rate=args.drop,
            drop_path_rate=args.drop_path,
        ...
        if not args.eval:
            ...
            teacher_model.to(device)
            teacher_model.eval()
    elif args.model == 'VideoMamba-Base':
        PRUNING_LOC = [6, 12, 18]
        model = create_model(
            'VideoMambaBaseDiffPruning',
            pretrained=False,
            num_classes=args.nb_classes,
            drop_rate=args.drop,
            drop_path_rate=args.drop_path,
    ...
    criterion = DistillDiffPruningLoss_dynamic(
        teacher_model, criterion, clf_weight=1.0, pruning_loc=PRUNING_LOC, keep_ratio=KEEP_RATE, mse_token=True, ratio_weight=16.0, distill_weight=0.5, dynamic=False
    )
    ...
    if args.eval:
        ...
        throughput(model, device, img_size=args.input_size)
