...
def train_one_epoch(model: torch.nn.Module, criterion: DistillDiffPruningLoss_dynamic,
    ...
    metric_logger.add_meter('ratio_loss', utils.SmoothedValue(window_size=1, fmt='{value:.6f}'))
    ...
    for samples, targets in metric_logger.log_every(data_loader, print_freq, header):
        ...
        metric_logger.update(ratio_loss=loss_parts[1].item())
...
@torch.no_grad()
def evaluate(data_loader, model, device, amp_autocast, model_name):
