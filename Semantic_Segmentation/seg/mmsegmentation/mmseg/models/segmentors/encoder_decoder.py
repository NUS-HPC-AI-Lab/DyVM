...
class EncoderDecoder(BaseSegmentor):
    ...
    def extract_feat(self, img):
        ...
        if self.training:
            x, token_ratio_loss, block_ratio_loss = self.backbone(img)
        else:
            x = self.backbone(img)
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        x, token_ratio_loss, block_ratio_loss = self.extract_feat(img)

        losses = dict()

        losses['token_ratio_loss'] = token_ratio_loss
        losses['block_ratio_loss'] = block_ratio_loss
