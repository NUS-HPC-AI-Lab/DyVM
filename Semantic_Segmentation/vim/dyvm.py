...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, stride=16, in_chans=3, embed_dim=768, norm_layer=None, flatten=True, strict_img_size: bool = True, dynamic_img_pad: bool = False,):
        super().__init__()
...
class DynamicBlock(nn.Module):
    ...
    def forward(
        ...
        hidden_states, block_policy = self.mixer(hidden_states, inference_params=inference_params, mask=mask, 
        cls_token_position=cls_token_position)
        return hidden_states, residual, block_policy
